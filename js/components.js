...
// data = a function returning the content (actually HTML)
	...
	Vue.component('resource-display', {
		...
		<div style="margin-top: -13px">
			...
			<span v-if="tmp[layer].passiveGeneration"><br>You are gaining {{format(tmp[layer].resetGain.mul(tmp[layer].passiveGeneration))}} {{tmp[layer].resource}} per second</span>
			<br><br>
